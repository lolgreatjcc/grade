...
export default function MarkSection(props) {
  ...
  return (
    <div className={`${styles.markParent}`}>
      <div className={`${styles.markTriangle}`} />
        ...
        <div className='flex'>
          <div>
            {correctness ?
              ...
              :
              <h1 className={`${styles.correctnessMessageWrong} mb-2`}>{correctnessMessage}</h1>
            }

            <h1>{elaborationText}</h1>
          </div>
          <div className='ps-4'>
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="m280-400 200-200 200 200H280Z" /></svg>
